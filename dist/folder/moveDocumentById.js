...
exports.moveDocumentById = void 0;
...
var moveDocumentById = exports.moveDocumentById = /*#__PURE__*/function () {
  var _ref3 = (0, _asyncToGenerator2.default)(function* (_ref, _ref2) {
    ...
    try {
      var filename = "".concat(__dirname, "/../resources/folders/moveDocumentById.graphql");
      var operations = _fs.default.readFileSync(filename).toString().replace(/[\n\r]/gi, '').replace('$folderId', folderId).replace('$documentId', documentId).replace('$sandbox', sandbox.toString());
  ...
  return function moveDocumentById(_x, _x2) {
