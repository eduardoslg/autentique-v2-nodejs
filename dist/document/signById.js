...
var signById = exports.signById = /*#__PURE__*/function () {
  var _ref3 = (0, _asyncToGenerator2.default)(function* (_ref, _ref2) {
    ...
    try {
      var filename = "".concat(__dirname, "/../resources/documents/signById.graphql");
      var operations = _fs.default.readFileSync(filename).toString().replace(/[\n\r]/gi, '').replace('$documentId', documentId).replace('$sandbox', sandbox.toString());
  ...
  return function signById(_x, _x2) {
